...
export const terminalData = [
  ...
  },
  {
    ...
    results: [
      "<a class='link' href='https://github.com/wizli595/ticketing_system' target='_blank'>Microservices Ticketing System</a>",
      "<a class='link' href='https://github.com/wizli595/The_Shop' target='_blank'>E-commerce The Shop</a>",
      "<a class='link' href='https://github.com/wizli595?tab=repositories' target='_blank'>Click here</a> to view all projects.",
    ],
  },
  {
    ...
    results: [
      ...
      "GitHub: <a class='link' href='https://github.com/wizli595' target='_blank'>wizli</a>",
    ],
  },
];
